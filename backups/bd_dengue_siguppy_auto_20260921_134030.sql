...
\restrict LxBN48reeNHytHU5A374bXVWHOiUf72AQsMQ05sVWmopgqf2O6TN5JdVCeStKJ8
...
SELECT pg_catalog.setval('public.actividad_zoocriadero_id_actividad_zoocriadero_seq', 4, true);
...
SELECT pg_catalog.setval('public.auditoria_id_auditoria_seq', 343, true);
...
SELECT pg_catalog.setval('public.copia_seguridad_historial_id_historial_seq', 4, true);
...
SELECT pg_catalog.setval('public.seguimiento_zoocriadero_id_seguimiento_seq', 4, true);
...
\unrestrict LxBN48reeNHytHU5A374bXVWHOiUf72AQsMQ05sVWmopgqf2O6TN5JdVCeStKJ8
