...
\restrict UgyXMOgUhtKVoNcu58Y13PUedzLAH5V4v6WspgDxbyvVOYydSxHmzFokaOfHRFh
...
SELECT pg_catalog.setval('public.actividad_zoocriadero_id_actividad_zoocriadero_seq', 1, true);
...
SELECT pg_catalog.setval('public.auditoria_id_auditoria_seq', 125, true);
...
SELECT pg_catalog.setval('public.zoocriadero_id_zoocriadero_seq', 4, true);
...
\unrestrict UgyXMOgUhtKVoNcu58Y13PUedzLAH5V4v6WspgDxbyvVOYydSxHmzFokaOfHRFh
