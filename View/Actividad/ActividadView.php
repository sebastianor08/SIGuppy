...
<head>
    ...
    <title>Actividades · SIGUppys</title>
...
<body data-page="terreno-actividades">
                ...
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-3">
                                Trabajo de terreno - Actividades
                            </h3>
                    ...
                    <div class="d-flex justify-content-end mt-4 only-coordinador">
                        ...
                        <button
                            ...
                            class="btn btn-primary btn-round btn-crear-actividad"
                ...
                <form id="actividadForm">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="descripcionActividad" class="form-label">
                                Descripción
                            </label>
                        ...
                        <div class="mb-3">
                            ...
                            <label for="estadoActividad" class="form-label">
                                Estado
                            </label>
    ...
    <script src="../../assets/js/siguppys-actividades.js"></script>
