...
// El "?? ''" significa: si no viene ese filtro en la URL, usa texto vacío
...
// --- SACAMOS LOS VALORES QUE YA EXISTEN, PARA LLENAR LOS SELECT ---
...
foreach ($actividades as $actividad) {
    // Convertimos las fechas de texto a un objeto DateTime para poder compararlas
...
// Contamos cuántas hay de cada estado, usando ya el arreglo FILTRADO
