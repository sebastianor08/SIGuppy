...
// Cada fila es UN pez: en qué tanque nació o murió, de qué sexo y en qué fecha.
$registros = [
...
// Para dibujar las barras del gráfico necesitamos saber cuál es el valor más alto
